...
<body>
  ...
  <footer class="footer">
    <span>Docker local + Node.js + MySQL + Redis + Elasticsearch</span>
...
<section class="hero">
  <div>
    ...
    <h1>Webcommerce Node.js rodando 100% local com Docker</h1>
    <p>Aplicação simples para demonstrar Docker Compose com Node.js, MySQL, Redis, Elasticsearch e volume Docker para mídias.</p>
...
<section>
  <div class="section-title">
    ...
    <span>Imagens vindas de um volume Docker</span>
  </div>
...
<section class="card">
  ...
  <p>Consulta usa cache Redis quando configurado. A busca principal usa Elasticsearch e faz fallback para MySQL se necessário.</p>
  <form class="searchbar" action="/busca" method="get">
...
<section class="form-wrapper card">
  ...
  <p>${isLogin ? 'Valide o acesso de um cliente cadastrado no MySQL local.' : 'Crie um cliente no MySQL local.'}</p>
